...
>
> _Para conocer más sobre el proyecto, consulta la [documentación del sprint 1](../sprint-1/README.md)_
...
|:-----------------------------------------------------------------------|:------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------|
| [**restaurants.json**](../../data/entities/restaurants.json)                 |         ![Restaurants](images/json-files/restaurants.png)         | Información detallada, horarios, coordenadas y menús.                                           |
| [**categories.json**](../../data/entities/categories.json)                   |          ![Categories](images/json-files/categories.png)          | Categorías (tipo de comida) para los restaurantes.                                              |
| [**bookings.json**](../../data/entities/bookings.json)                       |            ![Bookings](images/json-files/bookings.png)            | Registro de reservas, que vinculan usuarios con mesas específicas en fechas y horas concretas.  |
| [**reviews.json**](../../data/entities/reviews.json)                         |             ![Reviews](images/json-files/reviews.png)             | Registro de reseñas realizadas por usuarios a restaurantes.                                     |
| [**users.json**](../../data/entities/users.json)                             |               ![Users](images/json-files/users.png)               | Gestión de perfiles y credenciales para el sistema de login de usuarios registrados (clásicos). |
| [**restaurant-profiles.json**](../../data/entities/restaurant-profiles.json) | ![Restaurant Profiles](images/json-files/restaurant-profiles.png) | Gestión de perfiles de usuarios restaurantes. Vinculados a un restaurante por `restaurantId`.   |
...
|:-------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------|:----------------------------------------------------------------------------|
| ![Login1](images/validation/required.png) ![Login2](images/validation/checkJS.png) | ![CreateAccount](images/validation/checkCreateAcc.png) | ![BecomeAffiliate](images/validation/checkBecomeAffiliate.png) |
...
![Header](images/rwd/header.png)
![Footer](images/rwd/footer.png)
...
![Searcher](images/rwd/searcher.png)
...
![Restaurant Info](images/rwd/restaurant-info.png)
![Reviews](images/rwd/reviews.png)
...
![Booking Details](images/rwd/booking-details.png)
![Mapa Interactivo](images/rwd/mapa-interactivo.png)
![Popups](images/rwd/popups.png)
